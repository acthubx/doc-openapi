...
content_markdown: |-
    **How to manage a local order book correctly**
    ...
    1.Open a stream to wss://stream.acthubx.com/public , e.g. depth\_update@btc\_usdt.


    2.Buffer the events you receive from the stream.


    3.Get a depth snapshot from https://sapi.acthubx.com/v4/public/depth?symbol=btc\_usdt&limit=500
